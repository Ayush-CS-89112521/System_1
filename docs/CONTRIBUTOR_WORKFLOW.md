...
4. AI automation commits should include [AI] marker when generated by agent workflows.
5. If watchdog lock is active, use unlock command process before retrying PR merge.
